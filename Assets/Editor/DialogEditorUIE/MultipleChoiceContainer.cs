...
namespace DialogTool {
    ...
    public class MultipleChoiceContainer : VisualElement, ILineDraggable {
        ...
        public MultipleChoiceContainer() {
            VisualTreeAsset tree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Editor/DialogEditorUIE/MultipleChoiceContainer.uxml");
            StyleSheet style = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Editor/DialogEditorUIE/MultipleChoiceContainer.uss");
    ...
    public class DialogChunk : VisualElement, IColorDragTargettable {
        ...
        public DialogChunk() {
            VisualTreeAsset tree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Editor/DialogEditorUIE/DialogChunk.uxml");
            StyleSheet style = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Editor/DialogEditorUIE/DialogChunk.uss");
            VisualElement ui = tree.CloneTree();
    ...
    public class ChoiceEntry : VisualElement {
        ...
        public ChoiceEntry(MultipleChoiceContainer _multipleChoiceElement, string choiceString) {
            ...
            VisualTreeAsset tree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Editor/DialogEditorUIE/ChoiceEntry.uxml");
            StyleSheet style = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Editor/DialogEditorUIE/ChoiceEntry.uss");
