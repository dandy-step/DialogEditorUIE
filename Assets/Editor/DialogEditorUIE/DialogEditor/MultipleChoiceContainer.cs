...
namespace DialogTool {
    ...
    public class DragLinkElement : Image {
        ...
        public DragLinkElement() {
            Texture2D tex = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Editor/NodeEdit/Graphics/default_vert.png");
    ...
    public class MultipleChoiceContainer : VisualElement, ILineDraggable {
        ...
        public MultipleChoiceContainer() {
            StyleSheet style = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Editor/DialogEditorUIE/DialogEditor/MultipleChoiceContainer.uss");
            VisualTreeAsset tree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Editor/DialogEditorUIE/DialogEditor/MultipleChoiceContainer.uxml");
    ...
    public class DialogChunk : VisualElement, IColorDragTargettable {
        ...
        public DialogChunk() {
            VisualTreeAsset tree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Editor/DialogEditorUIE/DialogEditor/DialogChunk.uxml");
            StyleSheet style = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Editor/DialogEditorUIE/DialogEditor/DialogChunk.uss");
            VisualElement ui = tree.CloneTree();
    ...
    public class ChoiceEntry : VisualElement {
        ...
        public ChoiceEntry(MultipleChoiceContainer _multipleChoiceElement, string choiceString) {
            ...
            VisualTreeAsset tree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Editor/DialogEditorUIE/DialogEditor/ChoiceEntry.uxml");
            StyleSheet style = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Editor/DialogEditorUIE/DialogEditor/ChoiceEntry.uss");
